    ...
    <div className="navbar bg-base-100">
      <div className="flex-1">
        <a className="btn btn-ghost text-xl">
          <img src={logo} alt="Logo" className="h-[30px] md:h-[50px] lg:h-[49px] xl:h-[60px]" />
        </a>
      </div>
      <div className="flex-none">
        <div className="dropdown dropdown-end">
          ...
          <div tabIndex="0" className={`card card-compact dropdown-content bg-base-100 z-[1] mt-3 w-52 shadow ${user ? 'block' : 'hidden'}`}>
        ...
        {/* Display login/signup buttons or user info */}
        {!user ? (
          ...
          <div className="flex items-center">
            <span className="text-sm font-medium mr-4">{user.displayName}</span>
          </div>
        )}
      </div>
    </div>
