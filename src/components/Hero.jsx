      ...
      <div className="hero-content text-neutral-content text-center w-full p-4 sm:p-8 md:p-16">
        <div className="max-w-full mx-auto">
          ...
          <button
            ...
            className="btn bg-green-500 text-white px-4 py-2 rounded-md shadow-sm hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
          >
            Buy Now
          </button>
        </div>
